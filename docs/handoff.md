...
- AGENTS.md diperbarui: protokol efisiensi token, kuota menghitung token mentah, konvensi handoff, RTK dipersempit ke tool eksternal saja
...
- Prompt caching: Kilo Code menyisipkan Current time di setiap request = silent invalidator, caching tidak aktif dan tidak mengurangi kuota
- godot-open-rts: instrumentasi minimal, smoke PASS, coverage masih 2 screenshot saja
...
- `AGENTS.md` — protokol efisiensi token (bagian "Aturan Efisiensi Token")
...
- Kuota 150M menghitung token mentah — caching tidak membantu kuota
